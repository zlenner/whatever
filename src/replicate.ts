...
export class Replicate {
  ...
  constructor({ token, proxyUrl, httpClient, pollingInterval }: ReplicateInputProps = {}) {
    ...
    this.token ||= isNode ? process?.env?.REPLICATE_API_TOKEN : undefined;
  ...
  async startPrediction(modelVersion: string, input: PredictionInput, webhookCompleted: string | null = null) {
    return await this.callHttpClient({
      url: "/predictions",
      method: "post",
